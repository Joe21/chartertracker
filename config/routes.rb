Chartertracker::Application.routes.draw do  
  ...
  get 'home/funny' => 'home#funny', :as => 'funny'
...
#                    funny GET    /home/funny(.:format)              home#funny
...
#             image_police GET    /admins/:id/images(.:format)       admins#images
#             delete_image POST   /admins/:id/delete_image(.:format) admins#delete_image
